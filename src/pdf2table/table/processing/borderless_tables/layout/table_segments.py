...
from pdf2table.table.processing.borderless_tables.model import ImageSegment, TableSegment, Whitespace
from pdf2table.table.processing.borderless_tables.whitespaces import get_relevant_vertical_whitespaces, get_whitespaces
